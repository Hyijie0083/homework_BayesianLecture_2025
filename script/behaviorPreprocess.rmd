...
saveRDS(model_list_analysis_1, "../results/model_list_analysis_1_complete_pooling.rds")
...
# model_list_analysis_1 <- readRDS("../results/model_list_analysis_1_complete_pooling.rds")
...
ggplot(data = data_plot, 
       aes(x = probe_attribute, y = mean_acc, firll = cue_dimensionality, color = cue_dimensionality)) +
  smplot2::sm_bar() +
...
saveRDS(model_list_analysis_2, "../results/model_list_analysis_2_complete_pooling.rds")
```
