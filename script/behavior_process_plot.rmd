...
for (m in seq_along(model_list_analysis_2)){
  ...
  trace_par_cue2vs1 <- trace_par_cue2vs1
  ...
  rope_res_3vs2 <- bayestestR::rope(trace_par_cue3vs2, range = c(-0.1,0.1))
                                 
  hdi_2vs1 <- bayestestR::hdi(trace_par_cue2vs1, ci = 0.95)
  rope_res_2vs1 <- bayestestR::rope(trace_par_cue2vs1, range = c(-0.1,0.1))
  
  hdi_4vs3 <- bayestestR::hdi(trace_par_cue4vs3, ci = 0.95)
  rope_res_4vs3 <- bayestestR::rope(trace_par_cue4vs3, range = c(-0.1,0.1))
  ...
  p_4vs3 <- plot(rope_res_4vs3, rope_color = "grey70") +
    papaja::theme_apa() +
    ggtitle(paste(model_name, 'cue4vs3'))
  
  plot_list <- c(plot_list, p_2vs1, p_3vs2, p_4vs3)
}
